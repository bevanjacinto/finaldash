...
class ChartModule {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.4", ngImport: i0, type: ChartModule, deps: [{ token: ChartService }], target: i0.ɵɵFactoryTarget.NgModule }); }
